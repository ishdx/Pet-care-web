  ...
  if (isset($_POST['save_Pet'])) {
    ...
    if (empty($error)) {
      if(move_uploaded_file($_FILES["profileImage"]["tmp_name"], $target_file)) {
       ...
       $sql = "INSERT INTO `pet` (`Pet_ID`, `Pet_Photo`, `Pet_Name`, `D_Birth`, `Gender`, `Status`, `Medical_Record`, `Breed`, `Vaccine`, `Owner_ID`) VALUES (NULL, '".$profileImageName."', '".$pet_Name."', '".$D_Birth."', '".$Gender."', '".$Status."', '".$Medical_Records."','".$Breed."', '".$Vaccine."', $id)";
