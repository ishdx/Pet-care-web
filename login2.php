...
<div class="p-5 mb-4 bg-light rounded-3">
   ...
   if(isset($_GET["error"])){
    if($_GET["error"] == "emptyinput" ){
        ...
        echo "<p>Icorrect login information!<br>Please try again<br></p>";
    }
   }
   ?>
   </div></center>
...
<!-- User sign in form -->
<form id="form" action="login2.inc.php" method="post">
<div class="col-12">
<!--
<div class="col-12">
    <div class="col">  
    ...
    <div class="mb-3">
        ...
        <p><a href="ForgetPassword2.php" >forget password</a></p><br><br>
